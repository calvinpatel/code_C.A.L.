...
- ⬜ **FastAPI** — *~7–9 lessons* · **W1–2**
  Route handlers, Pydantic models, dependency injection (fixtures foreshadowed this), background tasks, async endpoints (Async Python arc lands here, pre-L6), OpenAPI docs. Modern Python's favorite web framework and my bridge to AI integration.
